...
Merhaba! İsmim Miraç Aral 1. Sınıf Bilgisayar Mühendisliği öğrencisi ve aynı zamanda ofansif güvenlik alanında yetkinliklerini sahada kanıtlamaya odaklanan bir Penetration Tester'ım. 
...
* **OSCP:** Ofansif güvenlik alanındaki yetkinliğimi sertifikalandırmak için aktif olarak OSCP sınavına hazırlanıyorum.
* **Mobil Geliştirme:** Yapay zeka destekli, hızlı terminal iş akışları kullanarak tatil konseptli bir mobil uygulama inşa ediyorum.
